...
cbind(tv,ts,round(tv$colMeansTv/ts$colMeansTs,2))[round(tv$colMeansTv/ts$colMeansTs,2)==1.94]
...
Use frequency of all mutations, but color according to tv versus ts ratio
